...
3. mGluRs inhibit the exocytotic machinery downstream of Ca²⁺ influx.  
...
- the postsynaptic MNTB neuron, to record EPSCs.  
    This allowed them to directly relate presynaptic ionic current to postsynaptic transmitter response.
...
**Outcome:**  
- Depolarisation of the presynaptic terminal produced a Ca²⁺ current, and this was followed by a sustained postsynaptic EPSC. 
...
**Outcome:**  
- ω-agatoxin IVA blocked most of the presynaptic Ca²⁺ current. The small residual current was abolished by Cd²⁺. 
  → Therefore, the presynaptic Ca²⁺ current is mainly mediated by **P/Q-type Ca²⁺ channels**.
- Nicardipine (L-type Ca<sup>2+</sup> channel blocker) had no effect.
...
**Outcome:**  
Reducing extracellular Ca²⁺ reduced presynaptic Ca²⁺ current amplitude. Below 1 mM Ca²⁺, the relation was approximately linear. This confirms that the recorded inward current depends on external Ca²⁺ entry.

----

# 4. Figure 2 — L-AP4 suppresses Ca²⁺ current but not K⁺ current

## Fig. 2A: Effect of L-AP4 on presynaptic Ca²⁺ current

**Method/process:**  
The authors applied 50-100 μM **L-AP4**, an agonist of group III mGluRs, especially mGluR4/6/7/8, while recording presynaptic Ca²⁺ currents.  
**Outcome:**  
- L-AP4 suppressed the presynaptic Ca²⁺ current, especially at an early phase around the peak. 
- Reversible after washout.
- The current–voltage relationship kept the same general shape, meaning L-AP4 reduced current amplitude without strongly shifting voltage dependence.  

- Similar effect for 1S,3S-ACPD (a broader-spectrum mGluR agonist).
- DCG-IV (specific agonist of mGluR subtypes 2 and 3) had no effect.

**Interpretation:**  
- mGluR activation directly or indirectly inhibits presynaptic Ca²⁺ channels.
...
**Outcome:**  
K⁺ currents before and after L-AP4 were almost identical.  
**Interpretation:**  
L-AP4 does **not** inhibit transmitter release by increasing or modifying presynaptic K⁺ current. This rules out the K⁺-conductance mechanism for this synapse.
...
2. applying L-AP4.  
    They recorded presynaptic Ca²⁺ current and postsynaptic EPSC simultaneously.  
    **Outcome:**  
...
**Outcome:**  
The slopes were similar for reduced Ca²⁺ and L-AP4.  
**Interpretation:**  
L-AP4 reduces EPSCs mainly by reducing presynaptic Ca²⁺ influx, rather than by directly inhibiting vesicle fusion downstream of Ca²⁺ entry.

----

# 6. Overall experimental logic

The paper proceeds through a clear sequence:

1. **Identify the presynaptic Ca²⁺ current** at the calyx of Held.
2. Show that this current is mainly **P/Q-type**.
3. Apply an mGluR agonist and show that it suppresses this Ca²⁺ current.
4. Test K⁺ currents and show they are not affected.
5. Compare Ca²⁺ current–EPSC relationships to show that reduced Ca²⁺ influx explains the reduced transmitter release.

# 7. Main conclusion

The main target of presynaptic mGluR-mediated inhibition at the calyx of Held is the **presynaptic P/Q-type Ca²⁺ channel**. Activation of mGluRs suppresses Ca²⁺ influx into the terminal, which reduces glutamate release and therefore decreases the postsynaptic EPSC.
